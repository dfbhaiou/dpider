...
public class RedisCacheManager {
     ...
     * @return
     */
    public boolean lradd(String key, Object value) {
        try {
     ...
     * @return
     */
    public boolean lradd(String key, Object value, long time) {
        try {
            redisTemplate.opsForList().rightPush(key, value);
            if (time > 0)
                expire(key, time);
     ...
     * @return
     */
    public boolean lradd(String key, List<Object> value) {
        try {
     ...
     * @return
     */
    public boolean lradd(String key, List<Object> value, long time) {
        try {
            redisTemplate.opsForList().rightPushAll(key, value);
            if (time > 0)
                expire(key, time);
     ...
     * @return
     */
    public boolean lladd(String key, Object value) {
        try {
